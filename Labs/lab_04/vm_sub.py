...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("arfreder/ipinfo")
    client.subscribe("arfreder/date")
    client.subscribe("arfreder/time")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("arfreder/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("arfreder/date", on_message_from_date)
    client.message_callback_add("arfreder/time", on_message_from_time)
